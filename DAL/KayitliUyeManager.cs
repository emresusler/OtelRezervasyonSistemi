   ...
   public class KayitliUyeManager
    {
        ...
        {
            var yeniKayitliUye=new KayitliUye{KayitliUyeID = kayitliUye.KayitliUyeID,Mail=kayitliUye.Mail,Sifre=kayitliUye.Sifre,Ad=kayitliUye.Ad,Soyad=kayitliUye.Soyad};
